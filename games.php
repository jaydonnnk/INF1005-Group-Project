                ...
                <select id="genre" name="genre" class="form-select">
                    ...
                    <?php foreach ($genres as $g): ?>
                        <option value="<?php echo htmlspecialchars($g); ?>"
                            <?php echo (isset($_GET['genre']) && $_GET['genre'] === $g) ? 'selected' : ''; ?>>
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <span class="badge <?php echo $diff_class; ?>"><?php echo htmlspecialchars($game['difficulty']); ?></span>
                                    </div>
                                    <p class="card-text"><?php echo htmlspecialchars($game['description']); ?></p>
                                    <div class="mt-auto">
                                        <p class="text-caramel fw-bold mb-2">
                                            <?php echo htmlspecialchars($game['min_players']); ?>&ndash;<?php echo htmlspecialchars($game['max_players']); ?> players &bull;
                                            $<?php echo htmlspecialchars($game['price_per_hour']); ?>/hr
                                        </p>
                                        <?php if ($is_logged_in): ?>
                                            <div class="d-flex gap-2">
                                                <a href="reviews.php?game_id=<?php echo $game['game_id']; ?>" class="btn btn-outline-primary btn-sm">
                                                    <span class="material-icons align-middle" style="font-size:1rem;" aria-hidden="true">rate_review</span> Review
                                                </a>
                                                <form method="post" action="process/process_wishlist.php" class="d-inline">
                                                    ...
                                                    <button type="submit" class="btn btn-outline-primary btn-sm">
                                                        <span class="material-icons align-middle" style="font-size:1rem;" aria-hidden="true">favorite_border</span> Wishlist
                                                    </button>
                                                </form>
                                            </div>
                                        <?php endif; ?>
