    ...
    <main class="container section-padding">
        ...
        try {
            ...
            foreach ($categories as $cat) {
                ...
                <section class="mb-5">
                    <h2>
                        <span class="material-icons align-middle text-caramel me-2" aria-hidden="true"><?php echo $icons[$cat]; ?></span>
                                            ...
                                            <?php if ($is_logged_in): ?>
                                                <form method="post" action="process/process_order.php" class="d-inline">
                                                    ...
                                                    <button type="submit" class="btn btn-primary btn-sm">
                                                        <span class="material-icons align-middle" style="font-size:1rem;" aria-hidden="true">add_shopping_cart</span>
                                                        Add to Order
                                                    </button>
                                                </form>
                                            <?php endif; ?>
