            ...
            <div class="col-md-8 col-lg-6">
                ...
                <form action="process/process_register.php" method="post" class="needs-validation" novalidate
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="pwd" name="pwd" class="form-control" minlength="8"
                            placeholder="Minimum 8 characters" required aria-describedby="pwdHelp">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="pwd_confirm" name="pwd_confirm" class="form-control" minlength="8"
